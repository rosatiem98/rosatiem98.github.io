...
The analysis preformed will be done with a small DNA data set with 19 samples from the extraction DNA and samples from the online database DNA. In total a data set of 399 sequences are analyzed. Number of sequences come from excluding species sequences that were not unique or duplicated and [species](https://github.com/rosatiem98/rosatiem98.github.io/blob/9027bb5a2635ec01c4091367c3b9e4804ab42a94/number_of_hits.tsv) of interest. 
