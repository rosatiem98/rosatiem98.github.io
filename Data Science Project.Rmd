...
The analysis preformed will be done with a small DNA data set with 19 samples from the extraction DNA and 655 smaples from the online database DNA. 
...
research_seqs <- readDNAStringSet("../Data_Course_ROSATI/Final Project/Research sequences/DNA extraction sequences.fasta")
...
```{r message=FALSE, warning=FALSE}
researchggmsa <- readRDS("../Data_Course_ROSATI/Final Project/ggmsa_resaerch_alignment_small.RDS")
